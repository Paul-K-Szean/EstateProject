...
public class ViewAdapterRecyclerProperty extends RecyclerView.Adapter<ViewAdapterRecyclerProperty.MyViewHolder> implements Filterable {
    private static final String TAG = ViewAdapterRecyclerProperty.class.getSimpleName();
    ...
    public ViewAdapterRecyclerProperty(Fragment fragment, ArrayList<Property> propertyArrayList) {
        ...
        holder.imgvLblFavouriteIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((favourite = favouriteCtrl.getUserFavouritePropertyDetails(user, property)) != null) {
                    ...
                    favouriteCtrl.serverUpdateFavouriteCount(fragment, property, KEY_ACTION_DECREASEFAVOURITE, holder.tvProDetFavouriteCount);
                } else {
                    Log.i(TAG, "Trying to favourite this property. ");
                    holder.imgvLblFavouriteIcon.setImageResource(R.drawable.ic_action_favourite);
                    // increase favourite count of this property
                    favouriteCtrl.serverUpdateFavouriteCount(fragment, property, KEY_ACTION_INCREASEFAVOURITE, holder.tvProDetFavouriteCount);
                }
            }
        });
